...
5. **Distribution review is separate.** Public source visibility does not complete Chrome Web Store disclosures, legal authorization language, license review, vulnerability intake, or platform-specific accessibility sign-off; those remain supported-distribution decisions.
